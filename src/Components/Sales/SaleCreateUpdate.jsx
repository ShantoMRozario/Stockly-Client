...
import { customerDropdownRequest, productDropdownRequest, salesCreateRequest } from "../../Api/SalesApiRequest";
import { removeProducts, resetFormValue, setFormValue, setSelectedProducts } from "../../Redux/Slices/SalesSlice";
...
const SaleCreateUpdate = () => { 
    ...
    const childBody = useSelector((state) => state.sale.selectedProducts)
    ...
    const handleCreateSales = async() => {
        ...
        // purchase api call
        let result = await salesCreateRequest(parentBody,childBody)
    ...
    return (
        <div>
        <h2 className="text-3xl font-bold mb-1 mt-5 text-center">Sales Create</h2>
