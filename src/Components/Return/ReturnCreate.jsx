...
import { customerDropdownRequest, productDropdownRequest, returnCreateRequest } from "../../Api/ReturnApiRequest";
import { removeProducts, resetFormValue, setFormValue, setSelectedProducts } from "../../Redux/Slices/ReturnSlice";
...
const ReturnCreate = () => {
    ...
    const parentBody = useSelector((state) => state.return.formValue)
    const childBody = useSelector((state) => state.return.selectedProducts)
    ...
    const handleCreateReturn = async() => {
        ...
        // purchase api call
        let result = await returnCreateRequest(parentBody,childBody)
    ...
    return (
        <div>
        <h2 className="text-3xl font-bold mb-1 mt-5 text-center">Return Create</h2>
            ...
            <div className="w-[50%] p-5">
                <div className="mb-4">
                    ...
                    <select
                        ...
                        value={parentBody.customerId}
                        onChange={(e) => dispatch(setFormValue({ name: 'customerId', value: e.target.value }))}
                    >
